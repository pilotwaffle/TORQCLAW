...
This document is the sole normative v0.5 source. It replaces v0.1-v0.4 and their addenda. Earlier documents, commit `2f40e3a`, and review receipts remain evidence only.
...
| Prior source | Disposition in v0.5 |
|---|---|
