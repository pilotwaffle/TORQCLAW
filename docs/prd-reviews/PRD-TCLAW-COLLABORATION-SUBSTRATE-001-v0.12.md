...
This document is the sole normative v0.12 source. It replaces v0.1-v0.11 and their addenda. Earlier documents, the commits recorded in the review-status history, and review receipts remain evidence only.
...
| Prior source | Disposition in v0.12 |
|---|---|
