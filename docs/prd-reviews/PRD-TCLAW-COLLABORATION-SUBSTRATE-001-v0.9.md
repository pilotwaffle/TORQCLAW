...
This document is the sole normative v0.9 source. It replaces v0.1-v0.8 and their addenda. Earlier documents, commits `2f40e3a`, `f851aae`, `cedae1f`, `1d981da`, and `3e53e75`, and review receipts remain evidence only.
...
- `ACK_CHANNEL_CURSOR` beyond the caller-visible bound returns `CURSOR_OUT_OF_RANGE`, and a re-added member cannot learn committed counts inside its removal window from any ack response;
...
| Prior source | Disposition in v0.9 |
|---|---|
